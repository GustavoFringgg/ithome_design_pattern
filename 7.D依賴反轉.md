...
![https://ithelp.ithome.com.tw/upload/images/20260904/20183470HGujH2vUQR.jpg](https://ithelp.ithome.com.tw/upload/images/20260904/20183470HGujH2vUQR.jpg)
...
正式上線的地方，帶 `OrderRepository`、`LineNotifier` 進去
...
像 `OrderCalculator` 這種純計算邏輯([可以在 Day4 找到程式碼](https://ithelp.ithome.com.tw/articles/10406442))，沒有外部依賴，也沒人會想突然換一套演算法進去測試(應該沒人?)，就也沒必要為了「符合 DIP」硬包一層抽象

該包抽象的，是那些**跨越系統邊界**的東西，資料庫、外部 API、檔案、時間、亂數這類「細節容易變、容易需要在測試裡假裝一份」的低層模組
...
[依賴反向原則 (Dependency-Inversion Principle, DIP)](https://notfalse.net/1/dip)
